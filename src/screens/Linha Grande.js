...
<ScrollView showsVerticalScrollIndicator={false}
  ...
  <View style={{width: '60%', paddingLeft: 15, justifyContent: 'center' }}>
    <Text style={{fontWeight: '600', color: '#fff', fontSize: 16, paddingRight: 5,}}>Espaçador Nivelador Linha Grande</Text>
    <Text style={{color: '#fff', fontWeight:'300'}}>• Para cerâmicas e porcelanatos de 5 a 14 mm de espessura</Text>
    <Text style={{color: '#fff', fontWeight:'300'}}>• Ideal para revestimentos de todos os formatos</Text>
  </View>
  <View style={{width: '40%', justifyContent: 'flex-end', alignItems: 'center'}}>
    <Image
      source={require('../../assets/clipGrande.png')}
      style={{ height: '100%', width: 150, marginRight: 20,}}
    />
  </View>
</View>

<Text style={{color: '#303030', fontSize: 30, fontWeight: 'bold', textAlign: 'center'}}>Cálculo de Consumo Linha Grande</Text>
