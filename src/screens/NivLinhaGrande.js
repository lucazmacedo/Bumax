...
export function NivLinhaGrande() {
            ...
            <ScrollView showsVerticalScrollIndicator={false}
             ...
             overScrollMode="never">
                <View style={{alignItems: 'center',}}>
                    <Text style={{ paddingTop: 30, fontSize: 22, fontWeight: '600', color: '#303030', textAlign: 'center'}}>Espaçador Nivelador Linha Grande</Text>
                    <Image
                        source={require('../../assets/clipGrande.png')}
                        style={{ height: 180, width: 180, }}
                    />
                    <View>
                            <Text >• Para cerâmicas e porcelanatos de 5 a 14 mm de espessura;</Text>
                            <Text >• Ideal para revestimentos de pequenos, médios e grandes formatos;</Text>
                            <Text >• Espaçamentos: 1 mm | 1,5 mm | 2 mm;</Text>
                            <Text >• Translúcido e resistente.</Text>
                    </View>
                ...
                <Image
                    ...
                    <Text
                            ...
                            return Linking.openURL(
                                "https://api.whatsapp.com/send/?phone=5547997610124&text=+Ol%C3%A1%21+Estou+acessando+o+aplicativo+e+gostaria+de+saber+mais+informa%C3%A7%C3%B5es+sobre+o+nivelador+de+pisos+linha+grande&app_absent=0"
                            );
                            } else {
                            return Linking.openURL(
                                "https://api.whatsapp.com/send/?phone=5547997610124&text=+Ol%C3%A1%21+Estou+acessando+o+aplicativo+e+gostaria+de+saber+mais+informa%C3%A7%C3%B5es+sobre+o+nivelador+de+pisos+linha+grande&app_absent=0"
