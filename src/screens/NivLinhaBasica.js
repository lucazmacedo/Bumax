...
export function NivLinhaBasica() {
    return (
        <View style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}
                ...
                <View style={{alignItems: 'center',}}>
                    <Text style={{ paddingTop: 30, fontSize: 22, fontWeight: '600', color: '#303030', textAlign: 'center'}}>Espaçador Nivelador Linha Básica</Text>
                    <Image
                    ...
                    <View style={{paddingRight: 10,}}>
                            ...
                            <Text style={{ textAlign: 'justify' }}>• Ideal para revestimentos de pequenos, médios e grandes formatos;</Text>
                            <Text style={{ textAlign: 'justify' }}>• Espaçamentos:  1,0 mm  |  1,5 mm  |  2,0 mm  |  3,0 mm.;</Text>
                            <Text style={{ textAlign: 'justify' }}>• Translúcido e resistente.</Text>
                    </View>
